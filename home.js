...
if (CookieStorage.canUseCookies()) {
  ...
  alert(
    'Cookies não funcionam em contextos inseguros no seu navegador. Utilize o Firefox ou inicie o site com o LiveServer. Sem cookies, algumas funcionalidades não são executadas.',
  );
}
